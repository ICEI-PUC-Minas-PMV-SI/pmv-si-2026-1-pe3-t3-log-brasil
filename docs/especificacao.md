...
O produto será denominado Log Brasil – Sistema de Gestão de Entregas. Ele será composto por módulos de cadastro (clientes, pedidos e veículos) e controle das entregas, incluindo acompanhamento de status e organização das operações logísticas.
